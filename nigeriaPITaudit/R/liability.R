...
#'
#' @param gross_emolument Numeric. The total earnings before deductions.
#' @param total_relief Numeric. The aggregate relief computed by \code{total_relief()}.
#'
#' @return A numeric value representing the taxable income. If deductions exceed gross emolument, the result is 0.
#'
#' @examples
#' taxable_income(5000000, 1000000)  # Returns 4000000
#'
#' @export
taxable_income <- function(gross_emolument, total_relief){
  return(gross_emolument - total_relief)
}
